...
\end{proof}
\begin{homeworkProblem}
    Suppose $\sup_{n}\norm{f_n}_{p}<\infty$ and $f_n\rightarrow f$ 
    a.e..
    \begin{enumerate}
        \item If $1<p<\infty$, then $f_{n}\rightarrow f$ weakly in 
        $L^{p}$.
        \item The result of (1) is false in general for $p=1$. 
        However, ture for $p=\infty$ if $\mu$ is $\sigma$-finite 
