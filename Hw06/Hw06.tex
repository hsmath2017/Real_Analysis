...
\begin{homeworkProblem}
    ...
    \begin{enumerate}
        \item \begin{displaymath}
            \lim_{n\rightarrow\infty}\int_{0}^{\infty}
            (1+(\frac{x}{n}))^{-n}\sin(\frac{x}{n})\dif x.
        \end{displaymath}
        \item \begin{displaymath}
            \lim_{n\rightarrow\infty}\int_{0}^{1}
            (1+nx^2)(1+x^2)^{-n}\dif x.
        \end{displaymath}
        \item \begin{displaymath}
            \lim_{n\rightarrow\infty}\int_{0}^{\infty}
            n\sin(\frac{x}{n})[x(1+x^2)]^{-1}\dif x.
        \end{displaymath}
        \item \begin{displaymath}
            \lim_{n\rightarrow\infty}\int_{a}^{\infty}
            n(1+n^2x^2)^{-1}\dif x.
        \end{displaymath}
    \end{enumerate}
\end{homeworkProblem}
...
\end{proof}
\begin{homeworkProblem}
    $f_n\rightarrow f$ in measure iff for every $\epsilon>0$ there exists $N\in\mathbb{N}$ 
    such that $\mu(\{x:|f_{n}(x)-f(x)|\ge\epsilon\})<\epsilon$ for $n\ge N$.
\end{homeworkProblem}
\begin{proof}
    $"\Rightarrow"$: Just by the definition of convergence in measure.

    $"\Leftarrow"$: $\forall\epsilon>0$, it suffices to show $\lim_{n\rightarrow\infty}
    \mu\{x:|f_{n}(x)-f(x)|\ge\epsilon\}=0$.

    Assume $\exists\epsilon_0\le\epsilon$ s.t. $\forall N$, $\exists N_0\ge N$ 
    s.t. 
    \begin{displaymath}
        \mu\{x:|f_{N_0}(x)-f(x)|\ge\epsilon\}\ge\epsilon_0.
    \end{displaymath}
    From the condition, $\exists \tilde{N}$ s.t. $\forall n>\tilde{N}$, 
    \begin{displaymath}
        \mu\{x:|f_n(x)-f(x)|\ge\epsilon_{0}\}<\epsilon_{0}.
    \end{displaymath}
    Since $\epsilon_0\le\epsilon$, for $n>\tilde{N}$, 
    \begin{displaymath}
        \epsilon_0>\mu\{x:|f_{n}(x)-f(x)|\ge\epsilon_{0}\}
        \ge\mu\{x:|f_{n}(x)-f(x)|\ge\epsilon\}.
    \end{displaymath}
    Contradict!
\end{proof}
\end{document}